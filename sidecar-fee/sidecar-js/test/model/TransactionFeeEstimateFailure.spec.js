...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubstrateApiSidecarV1.TransactionFeeEstimateFailure();
  });
  ...
  describe('TransactionFeeEstimateFailure', function() {
    it('should create an instance of TransactionFeeEstimateFailure', function() {
      // uncomment below and update the code to test TransactionFeeEstimateFailure
      //var instane = new SubstrateApiSidecarV1.TransactionFeeEstimateFailure();
      //expect(instance).to.be.a(SubstrateApiSidecarV1.TransactionFeeEstimateFailure);
    });

    it('should have the property code (base name: "code")', function() {
      // uncomment below and update the code to test the property code
      //var instance = new SubstrateApiSidecarV1.TransactionFeeEstimateFailure();
