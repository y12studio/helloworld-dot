 ...
 * @version 1.0.0-oas3
 */
var VestingSchedule = /*#__PURE__*/function () {
  /**
  ...
  function VestingSchedule() {
    _classCallCheck(this, VestingSchedule);
  ...
  _createClass(VestingSchedule, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('perBlock')) {
          obj['perBlock'] = _ApiClient["default"].convertToType(data['perBlock'], 'String');
        }
