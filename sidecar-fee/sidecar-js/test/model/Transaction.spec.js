...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubstrateApiSidecarV1.Transaction();
  });
  ...
  describe('Transaction', function() {
    it('should create an instance of Transaction', function() {
      ...
      //var instane = new SubstrateApiSidecarV1.Transaction();
      //expect(instance).to.be.a(SubstrateApiSidecarV1.Transaction);
    });

    it('should have the property tx (base name: "tx")', function() {
      // uncomment below and update the code to test the property tx
      //var instance = new SubstrateApiSidecarV1.Transaction();
