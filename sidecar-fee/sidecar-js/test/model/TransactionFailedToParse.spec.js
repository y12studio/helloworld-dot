...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubstrateApiSidecarV1.TransactionFailedToParse();
  });
  ...
  describe('TransactionFailedToParse', function() {
    it('should create an instance of TransactionFailedToParse', function() {
      // uncomment below and update the code to test TransactionFailedToParse
      //var instane = new SubstrateApiSidecarV1.TransactionFailedToParse();
      //expect(instance).to.be.a(SubstrateApiSidecarV1.TransactionFailedToParse);
    });

    it('should have the property code (base name: "code")', function() {
      // uncomment below and update the code to test the property code
      //var instance = new SubstrateApiSidecarV1.TransactionFailedToParse();
