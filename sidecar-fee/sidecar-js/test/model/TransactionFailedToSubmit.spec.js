...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubstrateApiSidecarV1.TransactionFailedToSubmit();
  });
  ...
  describe('TransactionFailedToSubmit', function() {
    it('should create an instance of TransactionFailedToSubmit', function() {
      // uncomment below and update the code to test TransactionFailedToSubmit
      //var instane = new SubstrateApiSidecarV1.TransactionFailedToSubmit();
      //expect(instance).to.be.a(SubstrateApiSidecarV1.TransactionFailedToSubmit);
    });

    it('should have the property code (base name: "code")', function() {
      // uncomment below and update the code to test the property code
      //var instance = new SubstrateApiSidecarV1.TransactionFailedToSubmit();
